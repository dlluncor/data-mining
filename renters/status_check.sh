...
ssh  -i ~/.ssh/bonjoy-team.pem ubuntu@52.88.57.201 'ps aux | grep [r]uby; tail data-mining/renters/data/out_full_8_0921212303.log | grep HITTING'
echo '52.88.93.86 full_crosses_9'
ssh  -i ~/.ssh/bonjoy-team.pem ubuntu@52.88.93.86 'ps aux | grep [r]uby; tail data-mining/renters/data/out_full_9_0921212303.log | grep HITTING'
echo '52.88.255.164 full_crosses_10'
ssh  -i ~/.ssh/bonjoy-team.pem ubuntu@52.88.255.164 'ps aux | grep [r]uby; tail data-mining/renters/data/out_full_10_0921212303.log | grep HITTING'
echo '52.88.163.127 full_crosses_11'
ssh  -i ~/.ssh/bonjoy-team.pem ubuntu@52.88.163.127 'ps aux | grep [r]uby; tail data-mining/renters/data/out_full_11_0921212303.log | grep HITTING'
echo '50.112.137.231 full_crosses_12'
ssh  -i ~/.ssh/bonjoy-team.pem ubuntu@50.112.137.231 'ps aux | grep [r]uby; tail data-mining/renters/data/out_full_12_0921212303.log | grep HITTING'
